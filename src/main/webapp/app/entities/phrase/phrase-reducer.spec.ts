...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './phrase.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHRASE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHRASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHRASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHRASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHRASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHRASE actions', async () => {
      const expectedActions = [
        {
