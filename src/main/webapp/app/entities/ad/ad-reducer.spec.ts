...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AD_LIST actions', async () => {
    ...
    it('dispatches FETCH_AD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AD actions', async () => {
      const expectedActions = [
        {
