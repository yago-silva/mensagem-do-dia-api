        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/api/phrases/author/**")).permitAll()
                    .requestMatchers(mvc.pattern("/api/categories/featured")).permitAll()
                    .requestMatchers(mvc.pattern("/api/authors/featured")).permitAll()
                    .requestMatchers(mvc.pattern("/api/tags/featured")).permitAll()
                    .requestMatchers(mvc.pattern("/api/phrases/featured")).permitAll()
