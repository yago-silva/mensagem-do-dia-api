...
class CategoryResourceIT {
    ...
    void createCategory() throws Exception {
        ...
        assertThat(testCategory.getFeatured()).isEqualTo(DEFAULT_FEATURED);
    ...
    void putExistingCategory() throws Exception {
        ...
        assertThat(testCategory.getFeatured()).isEqualTo(UPDATED_FEATURED);
    ...
    void partialUpdateCategoryWithPatch() throws Exception {
        ...
        partialUpdatedCategory.createdAt(UPDATED_CREATED_AT).active(UPDATED_ACTIVE);
